...
const Sports = () => {
  ...
  return (
    <>
      <div className='flex gap-[30px] max-w-[82%] mt-[40px] mx-auto'>
        <div className='w-[100%] flex-4 p-3'>

          <div className='background-color w-full flex justify-between p-4 rounded-[15px] mt-[30px]'>
            ...
            {!isMinimized && (
              ...
              >
                {sportsTopic.map((item, index) => (
                  <div key={index} className='flex mt-[20px] gap-[20px] sport-border-color pb-4 '>
                    ...
                    <div className='flex flex-col'>
                      ...
                      <p className='text-[14px] secondary-text-color flex-3 montserrat-secondary-font'>
                        {item.description}
                      </p>

                      <div className='flex justify-between mt-[10px] flex-1 items-center'>
                      ...
                      <h1 className='text-[14px] flex-1 font-bold primary-text-color montserrat-primary-font'>
                      ...
                      <div className='flex items-center gap-2'>
                        ...
                        <p className='montserrat-primary-font text-[14px] flex-1 font-bold primary-text-color'>
                          {item.postedBy}
                        </p>
                      </div>
                    </div>
          ...
          <div className='background-color w-[100%] mt-[30px] flex justify-between p-4 rounded-[15px]'>
            <h1 className='text-[28px] background-text-color px-3 montserrat-primary-font font-semibold'>
              The PP Team
            </h1>
        ...
        <div className='flex-2  p-2 '>
          ...
          <div className='card-background-color flex flex-col justify-center h-[200px]  py-4 px-12 rounded-[20px]'>
            <div className=' w-[100%] flex  justify-between  rounded-[15px]'>
              <div className='flex gap-2 '>
                <h1 className='text-[24px] font-bold primary-text-color montserrat-primary-font'>
                  Staff Online
                </h1>
                <p className='text-[24px] font-bold register-text-color montserrat-primary-font'>
                  (2)
                </p>
              </div>
              <Image src={darkminimize} alt='minimize' height={35} width={35} />
            </div>
              ...
              staffOnline.map((member, index) => {
                return <div key={index} className='flex items-center gap-2 mt-[10px]'>
                  ...
                  <div className='flex flex-col '>
                    ...
                    <p className='montserrat-secondary-font text-[14px] flex-1 font-bold secondary-text-color'>
                      {member.userRole}
                    </p>
                  </div>
                </div>
          ...
          <div className='card-background-color h-[70px] flex items-center mt-[30px]  py-4 px-12 rounded-[20px]'>
            <div className=' w-[100%] flex justify-between  rounded-[15px]'>
              <div className='flex gap-2'>
                <h1 className='text-[24px] font-bold primary-text-color montserrat-primary-font'>
                  Members Online
              ...
              <Image src={darkmaximize} alt='minimize' height={35} width={35} />
            </div>
          </div>
          <div className='card-background-color h-[70px] flex items-center mt-[30px]  py-4 px-12 rounded-[20px]'>
            <div className=' w-[100%] flex justify-between  rounded-[15px]'>
      ...
      <div className=' max-w-[82%] mt-[200px] mx-auto'>
        <ForumStastic />
      </div>
