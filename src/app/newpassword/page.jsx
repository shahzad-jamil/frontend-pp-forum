      ...
      <div className="max-w-[90%] grid grid-cols-1 lg:grid-cols-2 mx-auto item-center">
        <div className='w-[100%] order-2 md:order-1'>
          <div className='w-[80%] h-[100%] mx-auto  flex item-center flex-col  justify-center'>
            <h1 className='text-[40px] font-semibold mb-[10px] primary-text-color '>New Password</h1>
            ...
            <form action="">
              <div className="relative mt-[30px] w-full ">
                ...
                <div className='flex border-color rounded-[100px] pr-[20px]'>
                  <input type="text" placeholder='****************' className='w-full   secondary-text-color outline-none p-7 rounded-[100px] text-[14px]' />
              ...
              <div className="relative mt-[30px] w-full ">
                <label
                  ...
                  className="absolute text-[14px] -top-3 left-5 font-semibold px-2 bg-white primary-text-color"
                >
                  Confirm Password
                </label>
                <div className='flex border-color rounded-[100px] pr-[20px]'>
