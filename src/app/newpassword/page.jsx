              ...
              <div className="relative mt-[30px] w-full">
                ...
                <div className='flex items-center border-color rounded-[100px] pr-[20px]'>
                  <input
                    ...
                    placeholder='****************'
                    className='w-full montserrat-secondary-font dark:bg-primaryColor  secondary-text-color outline-none p-7 rounded-[100px] text-[14px]'
                  />
                  <Image
              ...
              <div className="relative mt-[30px] w-full">
                ...
                <div className='flex items-center border-color rounded-[100px] pr-[20px]'>
                  <input
                    ...
                    placeholder='*****************'
                    className='w-full secondary-text-color dark:bg-primaryColor  montserrat-secondary-font outline-none p-7 rounded-[100px] text-[14px]'
                  />
                  <Image
