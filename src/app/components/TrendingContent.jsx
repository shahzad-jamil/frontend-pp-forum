...
const TrendingContent = () => {
  ...
  return (
    <>
      ...
      <div className='card-background-color flex flex-col mt-[30px]  h-[600px]  py-4 px-12 rounded-[20px]'>
        ...
        </div>
        {
          trendingContent.map((trending, index) => {
            return <div className='flex  gap-2 mt-[10px]' key={index}>
              ...
              <div className='flex flex-col '>
                ...
                <div className='flex justify-between mt-[10px] items-center'>
                  <div className='flex items-center gap-2'>
                    <h1 className='montserrat-primary-font text-[11px]  font-bold primary-text-color'>
                      {trending.postedBy}
                  ...
                  <div className='flex items-center  gap-1'>
                    <h1 className='text-[11px] font-bold primary-text-color montserrat-primary-font'>
                      Replies:
                    </h1>
